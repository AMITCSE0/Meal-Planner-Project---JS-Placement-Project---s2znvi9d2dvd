...
// const res = fetch(
//   `https://api.spoonacular.com/recipes/715538/similar?apiKey=${ApiKey}`
// );

// res.then((responce) => {
//   const jsobject = responce.json();
//   jsobject.then((jsonresult) => {
...
// fetch(
//   "https://api.spoonacular.com/recipes/715538/similar?apiKey=8c40cbb8e7c741be9ba4cb0b150a9771"
// )
//   .then((response) => response.json())
//   .then((response) => console.log(response))
//   .catch((err) => console.error(err));
const ApiKey = "8c40cbb8e7c741be9ba4cb0b150a9771";
